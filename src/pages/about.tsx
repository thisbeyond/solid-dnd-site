...
export default function About() {
  ...
  return (
    <div class="leading-normal tracking-normal text-white bg-gradient">
      ...
      >
        <div class="px-3 lg:px-20 w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
          <div class="flex items-center">
            <a
              class="uppercase no-underline hover:no-underline font-bold text-2xl lg:text-3xl"
              href="#"
            >
              Solid DnD
            </a>
          ...
          <nav
            class="w-full flex-grow justify-end md:flex md:items-center md:w-auto hidden mt-2 md:mt-0 bg-white md:bg-transparent p-4 md:p-0 z-20"
            id="nav-content"
          >
